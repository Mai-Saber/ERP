  ...
  return (
    <Modal show={props.show} onHide={props.handleClose} className="Modal">
      <Modal.Header closeButton>
        <Modal.Title> {t("AddNewInvoiceFinalProducts")}</Modal.Title>
      </Modal.Header>
      <Modal.Body>
        <form action="post">
          ...
          <Row>
            ...
            <Col xs={3}>
              ...
              <Select
                ...
                name="category_id"
                value={props.newInvoiceFinalProduct?.category_id}
                label={t("Category")}
                onChange={(e) => {
                  getProducts(e);
            ...
            <Col xs={3}>
              ...
              <Select
                ...
                id="demo-simple-select"
                name="product_id"
                value={props.newInvoiceFinalProduct?.product_id}
                label={t("Product")}
                onChange={(e) => {
                  getFinalProducts(e);
                  props.handleChange(e);
            ...
            <Col xs={3}>
              ...
              <Select
                ...
                value={props.newInvoiceFinalProduct?.final_product_id}
          ...
          <Select
            ...
            value={props.newInvoiceFinalProduct?.measurement_unit_id}
          ...
          <TextField
            ...
            label={t("UnitPrice")}
            name="unit_price"
            value={props.newInvoiceFinalProduct?.unit_price}
            onChange={props.handleChange}
          />
          {/* count */}
          <TextField
            ...
            label={t("count")}
            name="count"
            value={props.newInvoiceFinalProduct?.count}
            onChange={props.handleChange}
          />
        </form>
      </Modal.Body>
